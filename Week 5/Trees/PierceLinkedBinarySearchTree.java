/**
 * PierceLinkedBinarySearchTree implements the BinarySearchTreeADT interface
 * with links.
 * 
 * @author Lewis and Chase
 * @version 4.0
 */
public class PierceLinkedBinarySearchTree<T> extends PierceLinkedBinaryTree<T>
                                        implements BinarySearchTreeADT<T>
{
    /**
     * Creates an empty binary search tree.
     */
    public PierceLinkedBinarySearchTree()
    {
        super();
    }
     ...
     *        search tree
     */
    public PierceLinkedBinarySearchTree(T element)
    {
        super(element);
        
        if (!(element instanceof Comparable))
            throw new NonComparableElementException("PierceLinkedBinarySearchTree");
    }
                                  ...
                                  throws ElementNotFoundException 
    {
        ...
        if (isEmpty())
            throw new ElementNotFoundException("PierceLinkedBinarySearchTree");
        else
        {
    ...
    public T removeMin() throws EmptyCollectionException 
    {
        ...
        if (isEmpty())
            throw new EmptyCollectionException("PierceLinkedBinarySearchTree");
        else 
        {
            if (root.left == null) 
            {
     ...
     */
    @Override
    public PierceLinkedBinarySearchTree<T> getLeft()
    { 
        // TODO: May need to implement.
        PierceLinkedBinarySearchTree<T> result = null;
        return result;
    }
     ...
     */
    @Override
    public PierceLinkedBinarySearchTree<T> getRight()
    {
        // TODO: May need to implement.
        PierceLinkedBinarySearchTree<T> result = null;
        return result;
    ...
    private BinaryTreeNode<T> findNode(T targetElement, BinaryTreeNode<T> next) 
    {
        ...
        if (((Comparable)next.getElement()).compareTo(targetElement) > 0) {
            temp = findNode(targetElement, next.getLeft());
        } else if (((Comparable)next.getElement()).compareTo(targetElement) < 0) {
