...
/**
 * PierceArrayList represents an array implementation of a list. The front of
 ...
 * @version 4.0
 */
public abstract class PierceArrayList<T> implements ListADT<T>, Iterable<T>
{
     ...
     */
    public PierceArrayList(int initialCapacity)
    {
        rear = 0;
    ...
    public T removeLast() throws EmptyCollectionException
    {
        ...
        if (isEmpty()) {
            throw new EmptyCollectionException("PierceArrayList");
        }
    ...
    public T remove(T element)
    {
        ...
        if (index == NOT_FOUND)
            throw new ElementNotFoundException("PierceArrayList");
	...
	/**
	 * ArrayListIterator iterator over the elements of an PierceArrayList.
	 */	
	private class ArrayListIterator implements Iterator<T>
	{
		 ...
		 * 
		 * @param modCount the current modification count for the PierceArrayList
		 */
