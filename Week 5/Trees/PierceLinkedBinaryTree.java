...
/**
 * PierceLinkedBinaryTree implements the BinaryTreeADT interface
 * 
 * @author Lewis and Chase
 * @version 4.0
 */
public class PierceLinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
     ...
     */
    public PierceLinkedBinaryTree(T element)
    {
     ...
     */
    public PierceLinkedBinaryTree(T element, PierceLinkedBinaryTree<T> left,
                                  PierceLinkedBinaryTree<T> right)
    {
        root = new BinaryTreeNode<>(element);
    ...
    public T getRootElement() throws EmptyCollectionException
    {
        // TODO: Implement this.
        if (isEmpty()) {
            throw new EmptyCollectionException("PierceLinkedBinaryTree");
        }
     ...
     */
    public PierceLinkedBinaryTree<T> getLeft()
    {
        // TODO: Implement this.
        if (isEmpty()) {
            throw new EmptyCollectionException("PierceLinkedBinaryTree");
        ...
        PierceLinkedBinaryTree<T> result = new PierceLinkedBinaryTree<T>();
     ...
     */
    public PierceLinkedBinaryTree<T> getRight()
    {
        // TODO: Implement this.
        if (isEmpty()) {
            throw  new EmptyCollectionException("PierceLinkedBinaryTree");
    ...
    public T find(T targetElement) throws ElementNotFoundException
    {
        ...
        if (current == null)
            throw new ElementNotFoundException("PierceLinkedBinaryTree");
    ...
    public String toString() 
    {
        ...
        PierceArrayUnorderedList<T> temp = new PierceArrayUnorderedList<T>();
        inOrder(root, temp);
    ...
    {
        PierceArrayUnorderedList<T> tempList = new PierceArrayUnorderedList<>();
    ...
    protected void inOrder(BinaryTreeNode<T> node, 
                           PierceArrayUnorderedList<T> tempList)
    {
        if (node != null)
        {
    ...
    {
        PierceArrayUnorderedList<BinaryTreeNode<T>> nodes = new PierceArrayUnorderedList<>();
        PierceArrayUnorderedList<T> tempList = new PierceArrayUnorderedList<>();
